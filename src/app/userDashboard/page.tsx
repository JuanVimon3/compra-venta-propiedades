...
export default function UserDashboard() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      badrooms: Number(rawData.badrooms),
      image: rawData.image
    };
  ...
  return (
    ...
    <form action= "" className="flex flex-col items-center" onSubmit={handleSubmit} >
      ...
      <div className="relative w-80 mt-2">
        <input type="string" id="descripcion"  className="peer border border-gray-300 rounded-md px-3 pt-5 pb-2 w-full focus:ring-2 focus:ring-[#840705] focus:outline-none" />
      ...
      <div className="relative w-80 mt-2">
        <input type="number" id="badrooms" name="badrooms"  className="peer border border-gray-300 rounded-md px-3 pt-5 pb-2 w-full focus:ring-2 focus:ring-[#840705] focus:outline-none" />
        <label htmlFor="badrooms" className="absolute left-3 top-2 text-gray-500 text-sm transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-[#840705] peer-focus:text-sm">
      ...
      <div className="relative w-80 mt-2">
        <input type="string" id="image" name="image"  className="peer border border-gray-300 rounded-md px-3 pt-5 pb-2 w-full focus:ring-2 focus:ring-[#840705] focus:outline-none" />
        <label htmlFor="image" className="absolute left-3 top-2 text-gray-500 text-sm transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-[#840705] peer-focus:text-sm">
          URL de la imagen
        </label>
      </div>

      <button className="flex items-center justify-center bg-[#840705] w-80 border rounded-md mb-10 mt-6 py-2 text-white cursor-pointer hover:bg-[#5c0404] transition" type="submit">
        Registrar propiedad
      </button>
